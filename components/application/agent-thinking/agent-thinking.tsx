...
const TONE_COLORS: Record<AgentThinkingTone, string> = {
  subtle: "var(--text-muted, var(--color-text-tertiary))",
  default: "var(--text-secondary, var(--color-text-secondary))",
  primary: "var(--text-primary, var(--color-text-primary))",
  accent: "var(--accent-text, var(--color-blue-500))",
};
...
export function AgentThinking({
  ...
  return (
    ...
    >
      ...
      <span
        aria-label={label}
        className={cx("text-sm font-medium", shimmer && "bui-agent-thinking-label")}
      >
        {label}
      </span>
