...
import { SettingRow, SettingSection, SettingSelect } from "./setting-controls";
                    ...
                    <div className="mx-auto w-full max-w-5xl">
                        ...
                        <div className="mt-4 flex items-center gap-2">
                            ...
                            <SearchInput
                                ...
                                className="h-10 min-w-0 flex-1 rounded-full border border-border-subtle bg-input-bg px-3"
                            />
                        </div>
