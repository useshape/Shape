...
export function GridReveal({
    ...
    return (
        <div
            ...
            className={cn("relative w-full overflow-hidden rounded-2xl bg-surface-3", className)}
        ...
        >
            ...
            {caption && !finished ? (
                <div className="pointer-events-none absolute bottom-3 left-3 flex h-6 items-center overflow-hidden rounded-full bg-black/45 px-2.5 backdrop-blur-md">
                    <span
                        className={cn(
                            "block whitespace-nowrap text-[11px] font-medium leading-6",
                            reduce ? "text-white/75" : "chat-grid-shimmer",
                        )}
                    >
                        {caption}
                    </span>
