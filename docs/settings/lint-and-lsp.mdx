...
Design autocomplete and diagnostics live under **Settings → Editor → Design**, not LSP. See [Design Tools](/docs/editor/design-tools) and [Visual Design](/docs/editor/visual-design).
