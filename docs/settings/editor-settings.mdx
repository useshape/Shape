...
description: Configure font, display, tabs, auto-save, and formatting in the CodeMirror editor.
order: 2
icon: ri-code-line
---

**Settings → Editor** controls how code looks and behaves in the CodeMirror editor.
...
**Settings → Editor → Design** toggles Tailwind inline controls, number scrubbing, design autocomplete, diagnostics, and design blame. See [Design Tools](/docs/editor/design-tools). Live-page inspect and apply is [Visual Design](/docs/editor/visual-design), not this settings group.
