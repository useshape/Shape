...
- **Editor**: tabbed CodeMirror area in the center (also Browser, Settings, and diffs)
...
**Window → Git Manager** opens a separate window for PRs, Actions, and checks. **View → Preview** opens the [Browser](/docs/editor/visual-design) tab.
