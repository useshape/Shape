...
Indexing quality depends on the project index, not a language server. See [Workspace Search](/docs/files/workspace-search).
...
Shape remembers the association for that file path. Language mode affects highlighting and completions.
