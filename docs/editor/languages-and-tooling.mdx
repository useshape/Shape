...
Toggle the main servers under **Settings → Features → Language Servers**. Details: [Lint and LSP](/docs/settings/lint-and-lsp) and [IntelliSense](/docs/editor/intellisense).
...
See [Visual Design](/docs/editor/visual-design) and [Design Tools](/docs/editor/design-tools).
