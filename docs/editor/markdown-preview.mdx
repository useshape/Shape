---
title: Markdown Preview in Shape
description: Live Markdown preview and split view in the Shape IDE editor for .md and .mdx files.
order: 3
...
| Mode | What you see |
| --- | --- |
| **Source** | Raw Markdown in the CodeMirror editor |
