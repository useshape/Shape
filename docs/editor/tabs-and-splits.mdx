...
**View → Preview** or the Chrome icon on the [activity bar](/docs/workspace/activity-bar) opens a **Browser** tab (`shape://browser`). Use it for the local app URL and [Visual Design](/docs/editor/visual-design). Close it with **Ctrl+W** like any other tab.
