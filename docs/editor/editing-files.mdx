...
The Shape **editor** is built on CodeMirror 6. It highlights common web languages, supports multi-cursor editing, and formats with Prettier when enabled.
...
The editor does not run language servers. Completions come from CodeMirror language packs, not TypeScript or ESLint language services.
