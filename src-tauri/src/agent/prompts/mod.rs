...
pub const PR_WALKTHROUGH_MD: &str = include_str!("PR_WALKTHROUGH.MD");
pub const PR_REVIEW_MD: &str = include_str!("PR_REVIEW.MD");
pub const PR_DRAFT_MD: &str = include_str!("PR_DRAFT.MD");
